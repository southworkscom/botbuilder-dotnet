...
namespace Microsoft.Bot.Builder.Azure.Tests
{
    ...
    public class CosmosDbStorageTests : StorageBaseTests
    {
        ...
        public async Task CreateObjectTest()
        {
            if (CheckEmulator())
            {
                await _createObjectTest(_storage);
            }
        }
        ...
        public async Task ReadUnknownTest()
        {
            if (CheckEmulator())
            {
                await _readUnknownTest(_storage);
            }
        }
        ...
        public async Task UpdateObjectTest()
        {
            if (CheckEmulator())
            {
                await _updateObjectTest(_storage);
            }
        }
        ...
        public async Task DeleteObjectTest()
        {
            if (CheckEmulator())
            {
                await _deleteObjectTest(_storage);
            }
        }
        ...
        public async Task HandleCrazyKeys()
        {
            if (CheckEmulator())
            {
                await _handleCrazyKeys(_storage);
            }
        }
...
#pragma warning disable SA1118 // Parameter should not span multiple lines
                dialogs.Add(new WaterfallDialog("test", steps: new WaterfallStep[]
                {
